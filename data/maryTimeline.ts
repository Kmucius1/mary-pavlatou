...
export const timelineSlides: TimelineSlide[] = [
  ...
  },
  {
    ...
    ctaHref: "/fashion",
    images: [
      { src: "/images/mary-archive-colorized-cream-hat-portrait.png", alt: "Mary Pavlatou — Colorized close-up portrait, cream hat with flowers and pearl choker", mode: "portrait", caption: "Mary Pavlatou · Live runway presentation · Colorized by Mary James" },
    ],
  },
  {
    id: "v",
