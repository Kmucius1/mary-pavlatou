  ...
  return (
    <div className="flex flex-col items-center gap-1">
      <div
        ...
        style={{ color: "#f5d050", fontSize: "28px" }}
      >
        MP
      </div>
...
export default function Footer() {
  return (
    <footer
      id="contact"
      style={{ backgroundColor: "#080808", borderTop: "1px solid rgba(245,208,80,0.62)" }}
    >
      {/* Top gold line */}
      <div style={{ height: "1px", background: "linear-gradient(90deg, transparent, #f5d050 25%, #f5d050 75%, transparent)" }} />
      ...
      <div
        style={{
          ...
          background: `repeating-linear-gradient(
            90deg,
            rgba(245,208,80,0.84) 0px,
            rgba(245,208,80,0.84) 4px,
            transparent 4px,
            transparent 8px
          )`,
        }}
      ...
      <div className="max-w-5xl mx-auto px-6 py-10 flex flex-col items-center gap-6">
        ...
        <div className="flex items-center gap-3 w-full max-w-md">
          <div style={{ flex: 1, height: "1px", background: "rgba(245,208,80,0.72)" }} />
          <svg width="8" height="8" viewBox="0 0 8 8" fill="none">
            <path d="M4 0 L8 4 L4 8 L0 4 Z" fill="#f5d050" opacity="0.5" />
          </svg>
          <div style={{ flex: 1, height: "1px", background: "rgba(245,208,80,0.72)" }} />
        </div>
        ...
        <p
          ...
          style={{ color: "#f5d050", opacity: 0.8 }}
        >
        ...
        <div className="flex flex-col items-center gap-1 text-center">
          <p className="font-serif italic text-[13px]" style={{ color: "rgba(245,208,80,0.55)" }}>
        ...
        <p
          ...
          style={{ color: "rgba(245,208,80,0.68)" }}
        >
