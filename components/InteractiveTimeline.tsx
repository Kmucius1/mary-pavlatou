...
const slides = [
  ...
  },
  {
    ...
    greek: "Το Όνειρό Της",
    body: "Her dream: to become one of the world's finest mannequins and one day create a good family. She achieved both. Her three sons are her greatest legacy.",
  ...
  },
  {
    ...
    body: "The Pulos Brothers carried her photographs and memories for decades, restoring every image with care. What remains is not only a record — it is devotion made visible.",
