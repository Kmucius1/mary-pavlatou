...
const cards = [
  {
    ...
    cta: "Read Her Story",
    img: "/images/book-portrait-diamond-earrings.png",
    imgW: 1388,
    imgH: 1838,
    imgPos: "center top",
    alt: "Mary Pavlatou — Portrait from the family archive",
  },
  {
    href: "/fashion",
    label: "Fashion World",
    ...
    cta: "Enter the World",
    img: "/images/gen-couture-atelier.png",
    imgW: 1376,
    imgH: 768,
    imgPos: "center center",
    alt: "Couture atelier — fashion world illustration",
  },
  {
    href: "/gallery",
    label: "Gallery",
    ...
    img: "/images/mary-portrait-framed.jpg",
    imgW: 900,
    imgH: 1660,
    imgPos: "center top",
    alt: "Mary Pavlatou — Portrait from the family archive",
  },
  {
    ...
    img: "/images/cover-hires.jpg",
    imgW: 1600,
    imgH: 1200,
    imgPos: "center center",
    alt: "Mary Pavlatou Memorial Archive — book cover",
  },
];
