...
const cards = [
  {
    ...
    cta: "Read Her Story",
    img: "/images/mary-young-portrait.jpg",
    imgW: 1388,
    imgH: 1838,
    imgPos: "center top",
    alt: "Mary Pavlatou — Colorized young portrait, family archive",
  },
  {
    href: "/fashion",
    label: "Fashion World",
    ...
    cta: "Enter the World",
    img: "/images/mary-runway-blue.jpg",
    imgW: 1388,
    imgH: 1838,
    imgPos: "center center",
    alt: "Mary Pavlatou — Blue ball gown on runway, colorized archival photograph",
  },
  {
    href: "/archive",
    label: "The Archive",
    ...
    img: "/images/pages-full.jpg",
    imgW: 1388,
    imgH: 1838,
    imgPos: "center center",
    alt: "Mary Pavlatou archive — original book pages, family collection",
  },
  {
    href: "/legacy",
    label: "Legacy",
    ...
    cta: "View Her Legacy",
    img: "/images/endsheet-portrait.jpg",
    imgW: 1388,
    imgH: 1838,
    imgPos: "center top",
    alt: "Mary Pavlatou — Portrait from the family archive endsheet",
  },
];
