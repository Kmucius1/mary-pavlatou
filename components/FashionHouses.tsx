...
export default function FashionHouses() {
  return (
    ...
    >
      {/* Gold lines */}
      <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: "1px", background: "linear-gradient(90deg, transparent, #f5d050 30%, #f5d050 70%, transparent)" }} />
      <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, height: "1px", background: "linear-gradient(90deg, transparent, #f5d050 30%, #f5d050 70%, transparent)" }} />
      ...
      <div style={{ maxWidth: "900px", margin: "0 auto" }}>
        ...
        <div className="text-center mb-14 animate-fade-in">
          ...
          <div className="flex items-center justify-center gap-3 mt-5">
            <div style={{ width: "80px", height: "1px", background: "#f5d050", opacity: 0.6 }} />
            <svg width="8" height="8" viewBox="0 0 8 8" fill="none">
              <path d="M4 0 L8 4 L4 8 L0 4 Z" fill="#f5d050" opacity="0.7" />
            </svg>
            <div style={{ width: "80px", height: "1px", background: "#f5d050", opacity: 0.6 }} />
          </div>
        </div>
          ...
          {houses.map((house, i) => (
            <div key={house.name} className="w-full animate-fade-up" style={{ animationDelay: `${i * 0.1}s` }}>
              <div
                ...
                style={{
                  borderBottom: i < houses.length - 1 ? "1px solid rgba(245,208,80,0.84)" : undefined,
                  textAlign: "center",
                }}
              >
                <h3
        ...
        <div className="flex items-center justify-center gap-3 mt-12">
          <div style={{ width: "60px", height: "1px", background: "rgba(245,208,80,0.5)" }} />
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
            <path d="M10 0 L12 7 L20 10 L12 13 L10 20 L8 13 L0 10 L8 7 Z" fill="#f5d050" opacity="0.5" />
          </svg>
          <div style={{ width: "60px", height: "1px", background: "rgba(245,208,80,0.5)" }} />
        </div>
      </div>
